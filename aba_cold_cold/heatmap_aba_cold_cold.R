...
normCount <- read.csv('normalizado_aba_cold_cold.csv', row.names = 1)

deSeqRes <- read.csv('results_aba_cold_cold.csv', row.names =1)
...
write.csv(allsig, 'allsig_aba_cold_cold.csv')
